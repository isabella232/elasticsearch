 ...
 */
public final class ResponseExceptionCustomization extends IOException {

    private final ResponseCustomization response;

    public ResponseExceptionCustomization(ResponseCustomization response) throws IOException {
        super(buildMessage(response));
        this.response = response;
    }

    static String buildMessage(ResponseCustomization response) throws IOException {
     ...
     */
    public ResponseCustomization getResponse() {
        return response;
    }
}
