 ...
 */
public final class RestClientCustomization implements Closeable {
    ...
    RestClientCustomization(CloseableHttpClient client, long maxRetryTimeoutMillis, Header[] defaultHeaders,
     ...
     */
    public ResponseCustomization performRequest(String method, String endpoint, Header... headers) throws IOException {
     ...
     * @throws ResponseException in case elasticsearch responded with a status code that indicated an error
     */
    public ResponseCustomization performRequest(String method, String endpoint, Map<String, String> params, Header... headers) throws IOException {
     ...
     * @throws ResponseException in case elasticsearch responded with a status code that indicated an error
     */
    public ResponseCustomization performRequest(String method, String endpoint, Map<String, String> params,
        ...
        for (HttpHost host : nextHost()) {
            ...
            ResponseCustomization response = new ResponseCustomization(request.getRequestLine(), host, httpResponse);
            ...
            lastSeenException = addSuppressedException(lastSeenException, new ResponseExceptionCustomization(response));
            switch(statusCode) {
                case 502:
                case 503:
                case 504:
    ...
    private void onFailure(HttpHost host) throws IOException {
        while(true) {
            DeadHostState previousDeadHostState = blacklist.putIfAbsent(host, new DeadHostState(DeadHostState.DEFAULT_TIME_SUPPLIER));
    ...
    public interface RequestConfigCallback {
         ...
         * value that the {@link RestClientCustomization.Builder} internally sets.
         */
    ...
    public interface HttpClientConfigCallback {
         ...
         * without losing any other useful default value that the {@link RestClientCustomization.Builder} internally sets.
